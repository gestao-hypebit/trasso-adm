...
export interface Database {
  public: {
    Tables: {
      ...
      clientes: {
        Row: { id: string; nome: string; empresa: string | null; email: string | null; telefone: string | null; whatsapp: string | null; cpf_cnpj: string | null; endereco: string | null; cidade: string | null; estado: string | null; cep: string | null; segmento: string | null; origem: string | null; status: string; tags: string[] | null; observacoes: string | null; responsavel_id: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; nome: string; empresa?: string | null; email?: string | null; telefone?: string | null; whatsapp?: string | null; cpf_cnpj?: string | null; endereco?: string | null; cidade?: string | null; estado?: string | null; cep?: string | null; segmento?: string | null; origem?: string | null; status?: string; tags?: string[] | null; observacoes?: string | null; responsavel_id?: string | null; created_at?: string; updated_at?: string }
        Update: { id?: string; nome?: string; empresa?: string | null; email?: string | null; telefone?: string | null; whatsapp?: string | null; cpf_cnpj?: string | null; endereco?: string | null; cidade?: string | null; estado?: string | null; cep?: string | null; segmento?: string | null; origem?: string | null; status?: string; tags?: string[] | null; observacoes?: string | null; responsavel_id?: string | null; created_at?: string; updated_at?: string }
      }
      interacoes: {
      ...
      propostas: {
        Row: { id: string; numero: string; cliente_id: string | null; titulo: string; descricao: string | null; status: string; validade: string | null; valor_total: number; desconto_percentual: number; valor_final: number; condicoes_pagamento: string | null; observacoes: string | null; responsavel_id: string | null; enviada_em: string | null; aprovada_em: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; numero: string; cliente_id?: string | null; titulo: string; descricao?: string | null; status?: string; validade?: string | null; valor_total: number; desconto_percentual?: number; condicoes_pagamento?: string | null; observacoes?: string | null; responsavel_id?: string | null; enviada_em?: string | null; aprovada_em?: string | null; created_at?: string; updated_at?: string }
